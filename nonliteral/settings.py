"""
Django settings for nonliteral project.
...
META_SITE_DOMAIN = 'nonliteral.org'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'nonliteral/core/static')

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'nonliteral/core/media')
