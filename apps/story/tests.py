...
class ModelTestCase(TestCase):
    def setUp(self):
        ...
        self.target_node = Chapter.objects.create(
            title="Target Node", text="Target Text"
        )
        ...
        self.user = ReaderUser.objects.create(
            username="testuser", energy=100, money=100, current_chapter=self.node
        )
